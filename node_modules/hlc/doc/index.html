   ...
   chain.registerAndEnroll( registrationRequest, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err, user</span>) </span>{
     ...
     tx.on(<span class="hljs-string">'error'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">err</span>) </span>{
        <span class="hljs-built_in">console</span>.log(<span class="hljs-string">"error on invoke: %j"</span>,err);
				...
				<pre><code>npm <span class="hljs-keyword">install</span> -g hlc
...
<span class="hljs-symbol">                file:</span> <span class="hljs-string">"/var/hyperledger/production/.membersrvc/tlsca.cert"</span>
				...
				<pre><code><span class="hljs-attribute">vagrant</span> ssh
</code></pre><p>Build the <b>Certificate Authority (CA)</b> server with the commands below:</p>
				<pre><code><span class="hljs-keyword">cd</span> $GOPATH/src/github.<span class="hljs-keyword">com</span>/hyperledger/fabric/membersrvc
<span class="hljs-keyword">go</span> build
</code></pre><p>Next, enable the security and privacy settings on the peer by setting <code>security.enabled</code> and <code>security.privacy</code> settings to <code>true</code> inside the <a href="https://github.com/hyperledger/fabric/blob/master/peer/core.yaml">core.yaml</a>. Then build the peer with the following steps.</p>
				<p>Build the peer process with the commands below.</p>
				<pre><code><span class="hljs-keyword">cd</span> $GOPATH/src/github.<span class="hljs-keyword">com</span>/hyperledger/fabric/peer
<span class="hljs-keyword">go</span> build
