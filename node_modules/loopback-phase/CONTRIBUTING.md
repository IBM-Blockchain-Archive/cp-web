...
Thank you for your interest in `loopback-phase`, an open source project
administered by StrongLoop.

Contributing to `loopback-phase` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-phase)
